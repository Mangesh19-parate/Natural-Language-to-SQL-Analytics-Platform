...
| T-26 | Self-correction loop + E1–E7 taxonomy | REQ-CORR-01/02 | T-23 | Each error class individually reproducible via seeded failing queries | 7 | P0 | test_self_correction.py + test_correction_api.py (E1..E7 loop + diffs) | Done |
| T-27 | E5 routing (auth errors never retried) | REQ-CORR-02 | T-26 | An authorization failure never triggers a regeneration attempt | 7 | P0 (critical) | test_self_correction.py::test_e5_authorization_never_retried (Rule R4.2) | Done |
