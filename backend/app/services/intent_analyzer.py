...
from app.schemas.intent import IntentClassification, IntentAnalysisResult


class IntentAnalyzerService:
    """
    Intent Analyzer Service (REQ-UNSUPP-01 / REQ-AUTH-03 / Tasks T-10, T-11 / Rules R2.1, R2.2, R2.3).
    Performs pre-generation classification and security gates before any SQL proposal is created.
    """
